...
| `podDisruptionBudget.minAvailable`              | Minimum number of pods that must be available                                                                                                 | `nil`   |
| `podDisruptionBudget.maxUnavailable`            | Maximum number of pods that can be unavailable                                                                                                | `nil`   |
