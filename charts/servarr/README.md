...
| `cleanuperr.env.QUEUECLEANER__IGNORED_DOWNLOADS_PATH`            | Path to ignored downloads list.                                                                                                     | `/ignored`                                                                      |
...
| `cleanuperr.env.CONTENTBLOCKER__IGNORED_DOWNLOADS_PATH`          | Path to ignored downloads for content blocker.                                                                                      | `/ignored`                                                                      |
...
| `cleanuperr.env.DOWNLOADCLEANER__IGNORED_DOWNLOADS_PATH`         | Path to ignored downloads for download cleaner.                                                                                     | `/ignored`                                                                      |
