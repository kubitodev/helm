...
| `jellyfin.service.externalTrafficPolicy`        | The external traffic policy to use for the service. Set to either Cluster or Local.                                                                                                                                | `Cluster`                      |
...
| `jellyfin.tailscale.enabled`                    | Whether to enable tailscale integration.                                                                                                                                                                           | `true`                         |
| `jellyfin.tailscale.mode`                       | The mode to use for tailscale integration. Can be 'sidecar' or 'ingress'. Ingress mode requires the tailscale operator and is required when enableDLNA is true.                                                    | `ingress`                      |
