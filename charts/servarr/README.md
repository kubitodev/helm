...
| `cleanuperr.env.QUEUECLEANER__IGNORED_DOWNLOADS_PATH`            | Path to ignored downloads list.                                                                                                     | `""`                                                                            |
...
| `cleanuperr.env.CONTENTBLOCKER__IGNORED_DOWNLOADS_PATH`          | Path to ignored downloads for content blocker.                                                                                      | `""`                                                                            |
